package com.uestc.rpcframeworksimple.util;
...
public final class CuratorUtils {
    ...
    public CuratorUtils(String address) {
        this.DEFAULT_ZOOKEEPER_ADDRESS = address;
    }
     ...
     */
    public void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
     ...
     */
    public List<String> getChildrenNodes(CuratorFramework zkClient, String rpcServiceName) {
     ...
     */
    public  void clearRegistry(CuratorFramework zkClient, InetSocketAddress inetSocketAddress) {
